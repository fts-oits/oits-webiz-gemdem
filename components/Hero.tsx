              ...
              <div className="pt-12 md:pt-16 transition-all duration-1000 delay-500 border-t border-white/10 max-w-2xl mx-auto lg:mx-0">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-8 sm:gap-12 lg:gap-14">
                  {TRUSTED_BY.map((partner, idx) => (
                    ...
                    >
                      <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl ${partner.color} flex items-center justify-center text-[10px] sm:text-xs font-black transition-all duration-500 group-hover:scale-115 group-hover:-rotate-3 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] shadow-sm hover:brightness-125`}>
                        {partner.icon}
                      </div>
